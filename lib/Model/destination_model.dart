...
List<Category> categories = [
  Category(title: 'Consultation', iconPath: 'assets/icons/categories/veterinarian.png'),
  Category(title: 'Grooming', iconPath: 'assets/icons/categories/trimming.png'),
  Category(title: 'Boarding', iconPath: 'assets/icons/categories/dog-house.png'),
  Category(title: 'Training', iconPath: 'assets/icons/categories/medal.png'),
];


List<String> categoriesOld = [
  'Consultation',
  'Grooming',
  'Boarding',
  'Training',
